...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/fannytaviles/Library/Application Support/luaglider2/dev";local SOCKET_PORT=35261;local GLIDER_MAIN_FOLDER= "/Users/fannytaviles/Documents/YoGoMe/examen/examen";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
